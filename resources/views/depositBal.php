                        ...
                        <div class="md:grid md:grid-cols-3 md:gap-6">
                            <div class="md:col-span-1">
                                <div class="px-4 sm:px-0">
                                    <h3 class="text-lg font-medium leading-6 text-gray-900">Deposit Amount</h3>
                                    <p class="mt-1 text-sm leading-5 text-gray-600">
                                        Here you can deposit customer's money
                                    </p>
                                </div>
                            </div>
                                ...
                                <div class="shadow overflow-hidden sm:rounded-md">
                                    <div class="px-4 py-5 bg-white sm:p-6">
                                        <form action="../../app/controller/checkaccountController.php" method="POST" id="form">
                                            <input type="hidden" value="deposit" name="featurename">
                                        ...
                                        <?php if ($_GET["userexist"] == "true") { ?>
                                            <form action="../depositAmt" method="POST">
                                                <div class="grid grid-cols-6 gap-6 px-4 pt-12">
                                                    ...
                                                    <div class="col-span-6 sm:col-span-3">
                                                        <label for="aadhar_card" class="block text-sm font-medium leading-5 text-gray-700">Enter Deposit Amount</label>
                                                        <input id="aadhar_card" class="mt-1 form-input block w-full py-2 px-3 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:shadow-outline-blue focus:border-blue-300 transition duration-150 ease-in-out sm:text-sm sm:leading-5" name="deposit_amt" required>
                                                    </div>
                                                    <div class="col-span-6 sm:col-span-3">
                                                    ...
                                                    <div class="col-span-6 flex items-center justify-center">
                                                        <button class="py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-indigo-600 shadow-sm hover:bg-indigo-500 focus:outline-none transition duration-150 ease-in-out" type="submit">Deposit</button>
